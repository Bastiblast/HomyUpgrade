...
export const planURL = `https://ecft.fulfillment.a2z.com/api/nssp/get_nssp_big_table_new?dashboard=true&fcSelected=MRS1&region=EU&startDate=${formatedDate}&startTime=00%3A00%3A01`

export const planListTemplate = [
  {
    fc: 'MRS1',
...
export const urlCSVPickSummary = `https://rodeo-dub.amazon.com/MRS1/CSV/ExSD?isEulerUpgraded=ALL&processPath=&fnSku=&fulfillmentServiceClass=ALL&exSDRange.quickRange=PLUS_MINUS_1_DAY
